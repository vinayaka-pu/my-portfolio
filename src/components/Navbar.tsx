  ...
  return (
    <nav className="fixed top-0 left-0 w-full bg-bohoBeige dark:bg-bohoDarkGreen shadow-md z-50">
      <div className="w-full px-6 lg:px-12 py-3 flex justify-between items-center">
        {/* Logo (Left-Aligned) */}
        <h1 className="text-2xl font-bold text-bohoGreen dark:text-bohoBeige">
          Who am I?
        </h1>

        {/* Navigation + Dark Mode Toggle (Right-Aligned) */}
        <div className="flex items-center space-x-4">
          <ul className="hidden sm:flex space-x-8 text-gray-700 dark:text-gray-200 font-medium">
            <li>
              <a
                href="#home"
                className="hover:text-bohoGreen dark:hover:text-bohoBeige transition"
              >
                Home
              </a>
            </li>
